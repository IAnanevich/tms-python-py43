...
. - - , Прочитать с файломох преобразований выводить на экран).ранённый
json('example.txt','r') файл и з example.txtапис файломать данные на дис файломк
в csv-файл, первой файл первой
с файломтрокой которого оз example.txtаглавив каждый с файломтолбец и добавив
новый столбец “телефон”. и добавив новый с файломтолбец и добавив новый столбец
“телефон”. “телефон”. .
"""
import json
import csv
